...
WITH period_metrics AS (
  ...
  GROUP BY e.industry, l.state, a.fiscal_year
),
...
SELECT
  ...
  app_count_2021,
  ROUND(
    100.0 * (app_count_2020 - app_count_2019) / NULLIF(app_count_2019, 0), 
    2
  ) AS app_count_change_2019_to_2020_pct,
  ROUND(
    100.0 * (app_count_2021 - app_count_2020) / NULLIF(app_count_2020, 0), 
    2
  ) AS app_count_change_2020_to_2021_pct,
  ROUND(
    100.0 * (app_count_2021 - app_count_2019) / NULLIF(app_count_2019, 0), 
    2
  ...
  ROUND(
    100.0 * (avg_wage_2020 - avg_wage_2019) / NULLIF(avg_wage_2019, 0), 
    2
  ) AS avg_wage_change_2019_to_2020_pct,
  ROUND(
    100.0 * (avg_wage_2021 - avg_wage_2020) / NULLIF(avg_wage_2020, 0), 
    2
  ) AS avg_wage_change_2020_to_2021_pct,
  ROUND(
    100.0 * (avg_wage_2021 - avg_wage_2019) / NULLIF(avg_wage_2019, 0), 
    2
  ...
  ROUND(
    100.0 * (median_wage_2020 - median_wage_2019) / NULLIF(median_wage_2019, 0), 
    2
  ) AS median_wage_change_2019_to_2020_pct,
  ROUND(
    100.0 * (median_wage_2021 - median_wage_2020) / NULLIF(median_wage_2020, 0), 
    2
  ) AS median_wage_change_2020_to_2021_pct,
  ROUND(
    100.0 * (median_wage_2021 - median_wage_2019) / NULLIF(median_wage_2019, 0), 
    2
